...
const layoutSingleton = (() => {
  if (globalThis.__layoutSingleton) return globalThis.__layoutSingleton;
  ...
  const initAppLayout = async (activePage) => {
    showAppShellLoader();
  ...
  const api = { initAppLayout, initLoginShell };
  globalThis.__layoutSingleton = api;
  return api;
})();

export const initAppLayout = layoutSingleton.initAppLayout;
export const initLoginShell = layoutSingleton.initLoginShell;
